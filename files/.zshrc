...
plugins=(git encode64 sudo fzf safe-paste docker colored-man-pages extract universalarchive urltools aliases gitignore systemd z zsh-syntax-highlighting)
